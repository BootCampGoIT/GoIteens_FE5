...
export const programs = [
    ...
    },
    {
        ...
        description: "Easily create your own custom Discord bots using a friendly user interface, no coding required!...",
        price: 430
    },
    {
        id: "3",
...
export const news = [
    {
        id: "1",
        category: "news",
        title: "Experiment 008: Play Next joins Steam Library",
        content: "Earlier this year, Experiment 008: Play Next entered the Steam Labs for testing. Using machine learning to make informed suggestions, the feature is designed to help users with extensive libraries decide which of their games to play next.Based on positive feedback from customers, Play Next has proved successful enough to graduate from the Lab. With today's Steam Client update, that functionality is now integrated into the Steam Library.Users who have unplayed (or very low playtime) games in their library, will now have a Play Next shelf available in the library view.",
    },
    {
        id: "2",
        category: "news",
        title: "Discord Bot Studio",
        content: "Easily create your own custom Discord bots using a friendly user interface, no coding required!...",
    },
    {
        id: "3",
        category: "news",
        title: "My Little Cloud",
        content: "My Little Cloud is an ASMR application but like none available on the market today. Enjoy thunder and rain sounds recorded by Emmy-winner and nature recording genius Gordon Hempton, while watching fluid animations on your computer screen.",
    }
]